...
const ExerciseVideos = ({exerciseVideos,name}) => {
  ...
  return (
    <Box sx={{marginTop:{lg:'200px',xs:'20px'}}} p='20px'>
        <Typography varaint='h3' mb='33px'>Watch <span style={{color:'#ff2625', textTransform:'capitalize'}} >{name}</span> exercise videos </Typography>
        <Stack justifyContent='flex-start' flexWrap='wrap' alignItems='center' sx={{flexDirection:{lg:'row'},gap:{lg:'70px',xs:'0'}}}>
